...
<title>Agriculture College Online System</title>
...
<div class="form-style" id="contact_form">
    ...
    <form action="pdf_form.php" id="contact_body" method="post">
		...
		<label for="f_occupation"><span>Father Occupation <span class="required">*</span></span>
            <input type="text" name="f_occupation" data-required="true"/>
        </label>
		<label><span>Father's Phone <span class="required">*</span></span>
		...
		<label for="dob"><span>Date of Birth <span class="required">*</span></span>
            <input type="text" name="dob" data-required="true" />
        </label>
        ...
        <label for="n_o_copies"><span>Number Of Copies <span class="required">*</span></span>
		...
		<label for="a_edu"><span>Additional Education with Certificate <span class="required"></span></span>
            <table width="100%" border="1px" style="border-collapse:collapse">
				...
				<tr >
					...
					<td>
						<input type="text" name="select2" data-required="true"   style="width:90px;border:none">
					</td>
					<td>
